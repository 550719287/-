...
class login_args(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'accountInfo', 'UTF8', None, ),  # 1
    )
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.accountInfo = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.accountInfo is not None:
            oprot.writeFieldBegin('accountInfo', TType.STRING, 1)
            oprot.writeString(self.accountInfo.encode('utf-8') if sys.version_info[0] == 2 else self.accountInfo)
            oprot.writeFieldEnd()
